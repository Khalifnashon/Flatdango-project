function renderOneMovie(movie){
    ...
    card.innerHTML = `
        ...
        <div class= "content">
            ...
            <p>
                Seats Capacity: ${movie.capacity}
            </p>
            <p>
                Tickets sold: <span class="ticket-count">${movie.tickets_sold}</span>
            </p>
        </div>
        <div class="buttons">
    ...
    card.querySelector(".buttons").addEventListener("click",() => {
        if (movie.tickets_sold < movie.capacity){
            ...
            movie.tickets_sold = "Sold Out"
        }
        
        card.querySelector('span').textContent = movie.tickets_sold
...
function ticketButton(e){
   ...
   fetch(`http://localhost:3000/movies/`,{
       ...
       headers: {
         ...
         body: JSON.stringify({tickets_available:ticket})
